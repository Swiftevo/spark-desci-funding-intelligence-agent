...
Agent analysis is based on retrieved project data, public web metadata, papers, citations, and field maturity signals.
```
...
The core Z.AI signal is the GLM-5.1 agent loop, tool calling, external evidence checks, cross-project retrieval, and real academic literature support.
